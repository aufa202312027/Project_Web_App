...
$customers = getRecords("SELECT id, full_name, email FROM customers WHERE is_active = 1 ORDER BY full_name");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            // Create order
            $sql = "INSERT INTO orders (customer_id, order_number, order_date, status, notes) 
                    VALUES (?, ?, ?, ?, ?)";
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        ...
                                        <option value="shipped" <?= $form_data['status'] === 'shipped' ? 'selected' : '' ?>>Shipped</option>
